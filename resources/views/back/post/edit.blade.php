            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card card-border-color card-border-color-danger">
                        <div class="card-header card-header-divider">Form<span class="card-subtitle">Edit Artikel</span>
                        </div>
                        <div class="card-body">
                            <form action="{{ route('admin.post.update', $post->id) }}" method="POST"
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <input type="text" name="meta_desc" value="{{ $post->meta_desc }}"
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('back/assets/img/article/' . $post->cover) }}" width="200"
                                        height="200">
                                    </img>
                                </div>
