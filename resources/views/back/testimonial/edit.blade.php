                            ...
                            <form action="{{ route('admin.testimonial.update', $testimonial->id) }}" method="POST"
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" id="name"
                                        name="name" value="{{ $testimonial->name }}" type="text"
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <input class="form-control @error('job_title') is-invalid @enderror" id="job_title"
                                        name="job_title" value="{{ $testimonial->job_title }}" type="text"
                                        placeholder="Jabatan">
                                ...
                                <div class="form-group pt-2">
                                    ...
                                    <select class="form-control @error('star') is-invalid @enderror" name="star">
                                        <option value="{{ $testimonial->star }}" selected>{{ $testimonial->star }}</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{ asset('back/assets/testimonial/' . $testimonial->image) }}" width="100"
                                        height="100">
                                </div>
