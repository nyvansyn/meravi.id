                        ...
                        <div class="slider pe-5">
                            <div class="py-90px wow img-custom-anim-top z-1 position-relative">
                                <p
                                    ...
                                    Tentang Kami</p>
                                <div class="lh-1 ds-6 fw-bold text-black mb-3">PT Merapi Visitama Indonesia

                                </div>
                                <div class="lh-1 ds-6 fw-bold text-black mb-3">( Meravi.id )
                                </div>

                                <p class="fs-4 fw-normal mb-4 text-justifys"><b>Meravi.id</b> merupakan Layanan terintegrasi
                                    Training Center, Event Organizer, dan Kemitraan untuk Community Management &
                                    Empowerment. </p>

                                <p class="fs-4 fw-normal mb-4 text-justifys"><b>Meravi.id</b> sebagai Mitra Pelaksana
                                    Program
                                    CSR/Pemberdayaan Masyarakat menyediakan layanan berupa Pelatihan, Pendampingan, Inkubasi
                                    dan Kemitraan untuk mengembangkan bisnis BUM Desa dan UMKM. </p>
                        ...
                        <div class="wow img-custom-anim-top">
                            <div class="z-2 position-relative">
                                <p
                                    ...
                                    Visi kami</p>
                                <div class="z-2 lh-sm ds-5 fw-bold text-black mb-5">Membangun Masyarakat & Komunitas yang
                                    Berdaya</div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="box-text overflow-hidden position-relative border-bottom border-primary bg-white">
                        <div class="w-100 p-5 position-absolute start-50 translate-middle-x bottom-0 z-1">
                            <p
                                class="sub-title  fs-5 px-4 py-2 d-inline-flex text-primary text-uppercase rounded-pill border bg-white">
                                Visi kami</p>
                            <div class="lh-1 ds-5 fw-bold text-black mb-3">Membangun Masyarakat & Komunitas yang Berdaya
                            </div>
                        ...
                        <div class="wow img-custom-anim-top">
                            <div class="z-2 position-relative">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    ...
                                    <p class="mb-0 text-black">Menyelenggarakan Pelatihan untuk Peningkatan Kapasitas SDM
                                    </p>
                                </div>
                                <div class="d-flex align-items-center mb-2">
                                    <i class="bi bi-check-circle me-2 text-primary"></i>
                                    <p class="mb-0 text-black">Menyelenggarakan Pendampingan untuk Pengembangan Ekonomi
                                        Lokal
                                    </p>
                                </div>
                                <div class="d-flex align-items-center mb-4">
                                    <i class="bi bi-check-circle me-2 text-primary"></i>
                                    <p class="mb-0 text-black">⁠Menyelenggarakan Inkubasi untuk Menciptakan Bisnis-Bisnis
                                        Baru
                                    </p>
                                </div>
                                <div class="d-flex align-items-center mb-4">
