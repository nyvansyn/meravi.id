<section class="about-section-3 container pd-top-120px">
    <div class="row">
        <div class="col-lg-6 col-12 position-relative wow img-custom-anim-left">
            <div class="z-2 position-relative pe-5">
                <p
                ...
                <p class="pb-2"><span class="fw-bold">Meravi.id</span> sebagai Mitra Pelaksana Program CSR/Pemberdayaan
                    Masyarakat menyediakan layanan berupa Pelatihan, Pendampingan, Inkubasi dan Kemitraan untuk
                    mengembangkan bisnis BUM Desa dan UMKM
                </p>
                ...
                <a href="https://wa.me/6287805900800" class="btn-black border-0 fs-5 mt-2" target="_blank"><i
        ...
        <div class="col-lg-6 col-12 mt-lg-0 mt-8">
            <div class="row wow img-custom-anim-top">
                <div class="col-md-6 col-12 px-10 px-md-0 d-flex flex-column pt-2 align-items-center">
                    <div>
                        <div class="card-hover text-center border py-5 mb-lg-5 mb-md-6 mb-5 card-services">
                            <img class="img-fluid" src="{{ asset('front/assets/images/home/Pelatihan.png') }}"
                                alt="Pelatihan" />
                    ...
                    <div>
                        <div class="card-hover text-center border py-5 mb-lg-5 mb-md-6 mb-5 card-services">
                            <img class="img-fluid" src="{{ asset('front/assets/images/home/Pendampingan.png') }}"
                                alt="Pendampingan" />
                            <p class="fw-bold text-black my-3">
                                Pendampingan
                            </p>
                ...
                <div class="col-md-6 col-12 px-10 px-md-0 d-flex flex-column pt-2 align-items-center pt-md-6">
                    <div>
                        <div class="card-hover text-center border py-5 mb-lg-5 mb-md-6 mb-5 card-services">
                            <img class="img-fluid" src="{{ asset('front/assets/images/home/Inkubasi.png') }}"
                                alt="Inkubasi" />
                            <p class="fw-bold text-black my-3">
                                Inkubasi
                            </p>
                    ...
                    <div>
                        <div class="card-hover text-center border py-5 mb-lg-5 mb-md-6 mb-5 card-services">
                            <img class="img-fluid" src="{{ asset('front/assets/images/home/Mitra.png') }}"
                                alt="Kemitraan" />
                            <p class="fw-bold text-black my-3">
                                Kemitraan
                            </p>
