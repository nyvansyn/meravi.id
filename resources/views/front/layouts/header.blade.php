        ...
        <div class="container py-2">
            <div class="d-flex flex-column flex-lg-row justify-content-between align-items-center">
                <div class="d-flex mb-lg-0 mb-3 flex-wrap align-items-center justify-content-center justify-content-lg-start gap-4">
                    ...
                    <a target="blank" href="https://www.instagram.com/meravi.id?igsh=MXhtNDc3aWJ1ZG1mbA==" class=" text-reset">
...
<header>
    <nav class="navbar navbar-expand-lg navbar-light w-100 z-4 tcmenu__wrap">
        <div class="container px-3">
            <a class="navbar-brand pe-4" href="index.html"><img src="{{ asset('front/assets/images/logo/meravilogo.svg') }}" alt="abon"></a>
            ...
            <div class="offcanvas offcanvas-start offcanvas-nav">
                <div class="offcanvas-header">
                    <a href="index.html" class="text-inverse"><img src="{{ asset('front/assets/images/logo/meravilogo.svg') }}" alt="abon"></a>
                </div>
                    ...
                    <div class="tcmenu__navbar-wrap tcmenu__main-menu d-none d-lg-flex">
                        <ul class="navbar-nav me-auto gap-4 align-items-lg-center navigation">
                            ...
                            <li class="nav-item dropdown menu-item-has-children">
                                <a class="nav-link fw-medium" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">Program</a>
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="#">Pemberdayaan UMKM</a></li>
                                    <li><a class="dropdown-item" href="#">Bumdes</a></li>
                                </ul>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link fw-medium" href="#">Portofolio</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link fw-medium" href="#">Mitra</a>
                            </li>
    ...
    <div class="tcmobile__menu">
        <nav class="tcmobile__menu-box">
            <div class="close-btn"><i class="fas fa-times"></i></div>
                <div class="nav-logo">
                    <a class="mobi-logo" href="index.html"><img src="{{ asset('front/assets/images/logo/meravilogo.svg') }}" alt="abon"></a>
                </div>
                ...
                <div class="tcmobile__menu-bottom">
                    ...
                    <div class="social-links">
                        <ul class="list-wrap">
                            ...
                            <li>
                                <a href="https://www.instagram.com/meravi.id?igsh=MXhtNDc3aWJ1ZG1mbA==" class=" text-reset">
                                    <i class="bi bi-instagram"></i>
                                </a>
                            </li>
                            <li>
    ...
    <div class="offcanvas offcanvas-end" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions">
        ...
        <div class="offcanvas-body">
            <div class="offCanvas__logo mb-5">
                <a href="index.html"><img src="{{ asset('front/assets/images/logo/meravilogo.svg') }}" alt="Logo"></a>
            </div>
