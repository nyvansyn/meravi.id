                            ...
                            <div class="hove-animation">
                                <div class="w-75 text-start position-absolute bottom-0 start-50 translate-middle-x">
                                    ...
                                    <p class="text-white fs-1 fw-bold border-bottom border-secondary pb-2">
                                        <a class="text-white">{{ $portofolio->title }} </a>
                                    </p>
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <div class="d-flex align-items-center mb-3">
                                            <p class="text-white ms-2 mb-0 fs-5">{{ $portofolio->desc }}</p>
                                            {{-- <i class="bi bi-envelope-fill text-white"></i>
                                            <a href="mailto:info@abon.com"
                                                class="text-white ms-2 mb-0 fs-5">info@abon.com</a> --}}
                                        </div>
                                    </div>
                                </div>
                            </div>
